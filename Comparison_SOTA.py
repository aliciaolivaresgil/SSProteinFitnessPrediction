...
if __name__=="__main__": 
    ...
    for dataset in datasets: 
        for model in models: 
            ...
            with open(f'results/predictions_comparison_sota_{model}_{dataset}.pk', 'wb') as file_predictions: 
                pk.dump(predictions, file_predictions)
            with open(f'results/scores_comparison_sota_{model}_{dataset}.pk', 'wb') as file_scores: 
